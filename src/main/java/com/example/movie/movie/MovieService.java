...
public class MovieService {
    ...
    public void addNewMovie(Movie movie){
        ...
        if(result != 1) {
            throw new IllformedLocaleException("oops something went wrong");
        }
    }
    ...
    public void deleteMovie(Integer id){
        ...
        movies.ifPresentOrElse(movie -> {
            ...
            if (result != 1) {
                throw new IllformedLocaleException("oops could not delete movie");
            }
        }, ()->{
    ...
    public Movie getMovie(int id) {
        return movieDao.selectMovieById(id)
                .orElseThrow(()->new NotFoundException(String.format("Movie with id %s is not found", id)));
    }
}
